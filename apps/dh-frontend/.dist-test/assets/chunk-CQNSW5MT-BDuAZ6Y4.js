import { C as createDefaultSharedCoreModule, S as createDefaultCoreModule, n as AbstractMermaidValueConverter, o as EmptyFileSystem, t as AbstractMermaidTokenBuilder, u as MermaidGeneratedSharedModule, v as TreeViewGrammarGeneratedModule, w as inject, x as __name } from "./chunk-KEIR6QF5-BkcPtfg-.js";
var TreeViewValueConverter = class extends AbstractMermaidValueConverter {
	static #_ = __name(this, "TreeViewValueConverter");
...
var TreeViewTokenBuilder = class extends AbstractMermaidTokenBuilder {
	static #_ = __name(this, "TreeViewTokenBuilder");
	constructor() {
		super(["treeView-beta"]);
	}
};
