...
var exprs = [
	...
	},
	{
		...
		populate: function populate(selector, query, _ref13) {
			var _ref14 = _slicedToArray(_ref13, 3), meta$1 = _ref14[0], comparatorOp = _ref14[1], number$2 = _ref14[2];
			query.checks.push({
...
var labelHalign = function labelHalign$1(halign) {
	switch (halign) {
		case "left":
...
var labelValign = function labelValign$1(valign) {
	switch (valign) {
		case "top":
...
var labelJustification = function labelJustification$1(halign) {
	switch (halign) {
...
BRp$9.calculateLabelDimensions = function(ele, text) {
	...
	for (var i$1 = 0; i$1 < lineCount; i$1++) {
		var line = lines[i$1];
		var metrics = c2d.measureText(line);
		var w = Math.ceil(metrics.width);
		var h = size;
		if (textMetrics === "glyph") {
			if (i$1 === 0) labelActualAscent = metrics.actualBoundingBoxAscent;
			if (i$1 === lineCount - 1) labelActualDescent = metrics.actualBoundingBoxDescent;
		}
