...
import { D as getThemeVariables3, a as clear, b as getConfig, c as configureSvgSize, x as getConfig2, z as sanitizeText } from "./chunk-WYO6CB5R-Cw7oSHEb.js";
...
var PathBuilder = class {
	...
	static #_ = __name(this, "PathBuilder");
	moveTo(x, y) {
		this.d += `M ${x} ${y} `;
		return this;
	}
...
var RailroadRenderer = class {
	...
	static #_ = __name(this, "RailroadRenderer");
	measureText(text) {
