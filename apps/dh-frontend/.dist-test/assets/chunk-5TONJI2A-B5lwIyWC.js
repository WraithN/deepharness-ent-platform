import { C as createDefaultSharedCoreModule, S as createDefaultCoreModule, g as RailroadGrammarGeneratedModule, n as AbstractMermaidValueConverter, o as EmptyFileSystem, t as AbstractMermaidTokenBuilder, u as MermaidGeneratedSharedModule, w as inject, x as __name } from "./chunk-KEIR6QF5-BkcPtfg-.js";
var RailroadTokenBuilder = class extends AbstractMermaidTokenBuilder {
	static #_ = __name(this, "RailroadTokenBuilder");
	constructor() {
		super(["railroad-beta"]);
	}
};
...
var RailroadValueConverter = class extends AbstractMermaidValueConverter {
	static #_ = __name(this, "RailroadValueConverter");
