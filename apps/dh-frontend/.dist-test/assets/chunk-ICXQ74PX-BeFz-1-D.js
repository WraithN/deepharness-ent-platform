import { n as log, t as select_default } from "./src-4Uq4GVbL.js";
import { B as basisOpen_default, F as step_default, G as bumpX, H as Basis, I as natural_default, J as linear_default, K as bumpY, L as monotoneX, N as stepAfter, P as stepBefore, R as monotoneY, U as basis_default, V as basisClosed_default, W as noop_default, nt as epsilon, z as linearClosed_default } from "./index-DbiBhjOw.js";
import { n as __name } from "./chunk-Y2CYZVJY-DUN_E3Zt.js";
import { R as sanitizeDirective, h as directiveRegex, p as detectType, r as assignWithDepth_default, s as common_default } from "./chunk-WYO6CB5R-Cw7oSHEb.js";
import { t as require_dist } from "./dist-RiTN_B_6.js";
...
function traverseEdge(points) {
	let prevPoint;
	let totalDistance = 0;
	points.forEach((point$2) => {
		totalDistance += distance(point$2, prevPoint);
		prevPoint = point$2;
	});
...
var calculatePoint = /* @__PURE__ */ __name((points, distanceToTraverse) => {
	...
	for (const point$2 of points) {
		if (prevPoint) {
			const vectorDistance = distance(point$2, prevPoint);
			...
			if (vectorDistance < remainingDistance) remainingDistance -= vectorDistance;
				...
				if (distanceRatio > 0 && distanceRatio < 1) return {
					x: roundNumber((1 - distanceRatio) * prevPoint.x + distanceRatio * point$2.x, 5),
					y: roundNumber((1 - distanceRatio) * prevPoint.y + distanceRatio * point$2.y, 5)
				};
			}
		}
		prevPoint = point$2;
...
function isLabelCoordinateInPath(point$2, dAttr) {
	const roundedX = Math.round(point$2.x);
	const roundedY = Math.round(point$2.y);
...
export { float32ArrayTag as A, stringTag as B, isBuffer as C, booleanTag as D, arrayTag as E, mapTag as F, uint8ClampedArrayTag as G, uint16ArrayTag as H, numberTag as I, cardinal_default as J, getTag as K, objectTag as L, int16ArrayTag as M, int32ArrayTag as N, dataViewTag as O, int8ArrayTag as P, regexpTag as R, isArrayLike as S, arrayBufferTag as T, uint32ArrayTag as U, symbolTag as V, uint8ArrayTag as W, utils_default as _, cleanAndMerge as a, isArguments as b, generateId as c, handleUndefinedAttr as d, interpolateToCurve as f, removeDirectives as g, random as h, calculateTextWidth as i, float64ArrayTag as j, dateTag as k, getEdgeId as l, parseFontSize as m, calculateTextDimensions as n, decodeEntities as o, isDetailedError as p, catmullRom_default as q, calculateTextHeight as r, encodeEntities as s, ZERO_WIDTH_SPACE as t, getStylesFromArray as u, wrapLabel as v, argumentsTag as w, isPrimitive as x, isTypedArray as y, setTag as z };
