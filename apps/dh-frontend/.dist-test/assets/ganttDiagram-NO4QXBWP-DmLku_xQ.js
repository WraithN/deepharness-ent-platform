import { _ as utils_default } from "./chunk-ICXQ74PX-BeFz-1-D.js";
import { i as require_dayjs_min, n as log, t as select_default } from "./src-4Uq4GVbL.js";
import { C as Color, D as define_default, E as rgbConvert, M as max, O as extend, S as nogamma, a as timeMonday, c as timeThursday, d as timeDay, f as timeHour, ft as __commonJSMin, g as linear, h as millisecond, i as timeFriday, j as min, l as timeTuesday, m as second, n as timeFormat, o as timeSaturday, p as timeMinute, pt as __toESM, r as timeMonth, s as timeSunday, t as time, u as timeWednesday, w as Rgb, x as hue } from "./index-DbiBhjOw.js";
import { n as __name } from "./chunk-Y2CYZVJY-DUN_E3Zt.js";
import { H as setAccDescription, K as setDiagramTitle, U as setAccTitle, a as clear, c as configureSvgSize, s as common_default, v as getAccDescription, w as getDiagramTitle, x as getConfig2, y as getAccTitle } from "./chunk-WYO6CB5R-Cw7oSHEb.js";
	...
	(function(t, s) {
		...
		var t, s, n = 1e3, i = 6e4, e = 36e5, r = 864e5, o = 31536e6, u = 2628e6, d = /^(-|\+)?P(?:([-+]?[0-9,.]*)Y)?(?:([-+]?[0-9,.]*)M)?(?:([-+]?[0-9,.]*)W)?(?:([-+]?[0-9,.]*)D)?(?:T(?:([-+]?[0-9,.]*)H)?(?:([-+]?[0-9,.]*)M)?(?:([-+]?[0-9,.]*)S)?)?$/, a = /\[([^\]]+)]|YYYY|YY|Y|M{1,2}|D{1,2}|H{1,2}|m{1,2}|s{1,2}|SSS/g, h = {
			...
			return y$1.calMilliseconds = function() {
				...
				var t$1 = this.$ms;
				this.$d.years = $(t$1 / o), t$1 %= o, this.$d.months = $(t$1 / u), t$1 %= u, this.$d.days = $(t$1 / r), t$1 %= r, this.$d.hours = $(t$1 / e), t$1 %= e, this.$d.minutes = $(t$1 / i), t$1 %= i, this.$d.seconds = $(t$1 / n), t$1 %= n, this.$d.milliseconds = t$1;
				...
				return n$1.replace(a, (function(t$2, s$1) {
