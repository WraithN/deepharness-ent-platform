...
export const Login: React.FC = () => {
  ...
  const [email, setEmail] = useState('admin@deepharness.com');
      ...
      <div className="flex-1 flex items-center justify-center p-8 lg:p-12 relative">
        <div className="w-full max-w-[400px] space-y-8">
          <div className="text-center lg:text-left">
            ...
            <p className="text-muted-foreground mt-2">请输入邮箱与密码登录</p>
          </div>
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <Input
                  id="email"
                  type="email"
                  placeholder="name@deepharness.com"
                  value={email}
