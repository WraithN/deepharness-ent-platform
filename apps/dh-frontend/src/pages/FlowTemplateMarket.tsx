...
const AI_DEV_TEMPLATE: FlowTemplate = {
  ...
  stageDetails: [
    ...
    },
    {
      ...
      description: '判断是否需架构设计或直接开发。',
      responsibleRule: 'AI 初审 + 人工决策',
      aiCapability: '复杂度判断与路径推荐',
      admission: '需求已受理',
      deliverables: '决策：直接开发 / 架构设计',
    },
    {
      name: STAGE_NAMES.ARCH_DESIGN,
      description: 'AI 生成技术方案与架构设计。',
      responsibleRule: 'AI 架构助理',
      aiCapability: '技术选型、模块拆分、接口草案',
      admission: '判定需要架构设计',
      deliverables: '架构方案、接口草稿、任务拆分',
    },
    {
      name: STAGE_NAMES.AI_EVAL,
      description: 'AI 自评架构方案，识别潜在风险。',
    ...
    },
    {
      ...
      description: 'AI 根据反馈自动修复优化代码。',
      responsibleRule: 'AI 优化助理',
      aiCapability: '评审反馈修复、补测、重新提交',
      admission: '判定需要优化',
      deliverables: '优化后代码与测试',
    },
    {
      name: STAGE_NAMES.DEV_COMPLETE,
      description: '确认代码质量达标，流程结束。',
      responsibleRule: '技术负责人最终确认',
      admission: '人工评审通过',
      deliverables: '可合并的代码分支',
    },
  ],
  responsibleRules: [
    { role: '产品经理/需求受理人', items: ['需求录入与确认'] },
    { role: '技术负责人/架构师', items: ['架构与技术决策'] },
    { role: 'AI 开发数字分身', items: ['端到端代码开发与测试'] },
    { role: '代码审查人/技术负责人', items: ['人工评审'] },
  ],
  aiCapabilities: [
    { role: 'AI 架构助理', items: ['自动生成技术方案与接口设计'] },
    { role: 'AI 评审助理', items: ['评估方案风险与代码质量'] },
    { role: 'AI 开发数字分身', items: ['端到端代码开发与测试'] },
    { role: 'AI 优化助理', items: ['根据反馈自动修复与优化'] },
  ],
  admissions: [
    '需求已完成录入并指派',
    'AI 评估或人工决策确认开发路径',
