...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ...
    className={cn(
      ...
      // 遮罩与 AlertDialog 统一（DESIGN.md 14.2）：亮色浅调无模糊，暗色深遮罩。
...
>(({ className, children, onOpenAutoFocus, hideClose, container, ...props }, ref) => (
  <DialogPortal container={container}>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        // 实色弹窗盒（DESIGN.md 14.2）：不透明白底 + 蓝灰边框 + 柔和阴影。
        "bg-white border border-[rgba(148,163,184,0.18)] shadow-[0_10px_32px_rgba(15,23,42,0.12)]",
        "dark:bg-[#1E293B] dark:border-[rgba(148,163,184,0.15)] dark:shadow-[0_8px_32px_rgba(0,0,0,0.35)]",
        className
      )}
      {...props}
    >
