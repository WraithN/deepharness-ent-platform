...
func New(cfg config.Config) (http.Handler, func()) {
	...
	mux.HandleFunc(ROUTE_WORKSPACES_BY_ID_REPOSITORIES_BY_REPO_ID, repository.RepositoryByID)
	mux.HandleFunc(ROUTE_WORKSPACES_BY_ID_REPOSITORIES_BY_REPO_ID_STANDARD_FILES, repository.StandardFiles)
	mux.HandleFunc(ROUTE_WORKSPACES_BY_ID_REPOSITORIES_BY_REPO_ID_STANDARD_FILES_INIT, repository.StandardFilesInit)
	mux.HandleFunc(ROUTE_WORKSPACES_BY_ID_REPOSITORIES_BY_REPO_ID_SYNC, repository.SyncRepository)
	mux.HandleFunc(ROUTE_WORKSPACES_BY_ID_REPOSITORIES_BY_REPO_ID_DETAILS, repository.RepositoryDetails)
