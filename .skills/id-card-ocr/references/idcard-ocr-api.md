...
| Endpoint | `POST https://app-bycc1mwfyi9t-api-k93RZBjP0zqa-gateway.appmiaoda.com/rest/2.0/ocr/v1/idcard` |
| Content-Type | `application/x-www-form-urlencoded` |
| Auth Header | `X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}` |
| 认证模式 | `platform_managed` |
| third_part_domain | `app-bycc1mwfyi9t-api-k93RZBjP0zqa-gateway.appmiaoda.com` |
...
async function recognizeIdCard(
  ...
  const response = await fetch(
    "https://app-bycc1mwfyi9t-api-k93RZBjP0zqa-gateway.appmiaoda.com/rest/2.0/ocr/v1/idcard",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/x-www-form-urlencoded",
...
- **第三方域名**：实际请求转发至 `app-bycc1mwfyi9t-api-k93RZBjP0zqa-gateway.appmiaoda.com`，网关代理后客户端无需感知。
