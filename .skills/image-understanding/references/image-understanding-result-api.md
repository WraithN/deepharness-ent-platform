...
| Endpoint | `POST https://app-bycc1mwfyi9t-api-zYkZz8qoKDdL-gateway.appmiaoda.com/rest/2.0/image-classify/v1/image-understanding/get-result` |
| 生成期 URL（含 API ID） | `https://app-bycc1mwfyi9t-api-zYkZz8qoKDdL-gateway.appmiaoda.com/rest/2.0/image-classify/v1/image-understanding/get-result` |
| Content-Type | `application/json` |
| Auth Header | `X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}` |
| 认证模式 | `platform_managed` |
| third_part_domain | `app-bycc1mwfyi9t-api-zYkZz8qoKDdL-gateway.appmiaoda.com` |
| 计费 | 不启用（查询接口免费） |
...
async function getImageUnderstandingResult(
  ...
  const response = await fetch(
    "https://app-bycc1mwfyi9t-api-zYkZz8qoKDdL-gateway.appmiaoda.com/rest/2.0/image-classify/v1/image-understanding/get-result",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
