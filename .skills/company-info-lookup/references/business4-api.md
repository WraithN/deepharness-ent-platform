...
| Endpoint | `GET https://app-bycc1mwfyi9t-api-e94GZ5j0Kxja-gateway.appmiaoda.com/business4/get` |
| Auth 模式 | platform_managed |
| Auth Header | `X-Gateway-Authorization: Bearer ${apiKey}` |
| Content-Type | `application/json;charset=UTF-8` |
| third_part_domain | `app-bycc1mwfyi9t-api-e94GZ5j0Kxja-gateway.appmiaoda.com` |
...
async function queryBusinessInfo(keyword: string): Promise<BusinessQueryResult> {
  const url = new URL(
    "https://app-bycc1mwfyi9t-api-e94GZ5j0Kxja-gateway.appmiaoda.com/business4/get"
  );
