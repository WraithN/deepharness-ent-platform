...
| Endpoint | `POST https://app-bycc1mwfyi9t-api-Xa6JZxjyPlNa-gateway.appmiaoda.com/stock/hs/blocklist` |
| Auth | `platform_managed`（`X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}`） |
| Content-Type | `application/x-www-form-urlencoded` |
| Third-party domain | `app-bycc1mwfyi9t-api-Xa6JZxjyPlNa-gateway.appmiaoda.com` |
...
async function fetchBlockList(
  ...
  const response = await fetch(
    "https://app-bycc1mwfyi9t-api-Xa6JZxjyPlNa-gateway.appmiaoda.com/stock/hs/blocklist",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/x-www-form-urlencoded",
