...
- **Endpoint**：`POST https://app-bycc1mwfyi9t-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query`
...
async function queryIsbnInfo(isbn: string): Promise<IsbnDetail[]> {
  const url = new URL("https://app-bycc1mwfyi9t-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query");
