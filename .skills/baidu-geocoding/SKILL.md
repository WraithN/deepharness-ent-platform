...
|------|------|----------|--------|
| 地理编码 | 地址 → 坐标 | `GET https://app-bycc1mwfyi9t-api-GaDwZ0j3erOY-gateway.appmiaoda.com/geocoding/v3/` | GET |
| 逆地理编码 | 坐标 → 地址 | `GET https://app-bycc1mwfyi9t-api-baBwZEjbe1X9-gateway.appmiaoda.com/reverse_geocoding/v3` | GET |
...
const response = await fetch(
  `https://app-bycc1mwfyi9t-api-GaDwZ0j3erOY-gateway.appmiaoda.com/geocoding/v3/?${params}`,
  {
    method: "GET",
    headers: {
