...
- **Endpoint**: `POST https://app-bycc1mwfyi9t-api-o9wN0mk1DAPa-gateway.appmiaoda.com/driverexam/query`
...
async function queryDrivingExamQuestions(
  ...
  const response = await fetch(
    `https://app-bycc1mwfyi9t-api-o9wN0mk1DAPa-gateway.appmiaoda.com/driverexam/query?${params.toString()}`,
    {
      method: "POST",
      headers: {
